...
const Footer = () => {
  return (
    <>
      <footer className="footer-1 bg-emerald-300 dark:bg-zinc-900 py-8 sm:py-12 mt-10 ">
        <div className="container mx-auto px-1">
          <div className="sm:flex sm:flex-wrap sm:-mx-4 md:py-4">
            <div className="px-20 sm:w-1/2 md:w-1/4 xl:w-1/6">
              <h5 className="text-3xl font-bold mb-6 dark:text-white">Features</h5>
            ...
            <div className="px-20 sm:w-1/2 md:w-1/4 xl:w-1/6 mt-8 sm:mt-0">
              <h5 className="text-3xl font-bold mb-6 dark:text-white">Resources</h5>
              <ul className="list-none footer-links">
                <li className="mb-2">
                  <a
                    href="#"
            ...
            <div className="px-20 sm:w-1/2 md:w-1/4 xl:w-1/6 mt-8 md:mt-0">
              <h5 className="text-3xl font-bold mb-6 dark:text-white">About</h5>
              <ul className="list-none footer-links">
                <li className="mb-2">
                  <a
                    href="#"
            ...
            <div className="px-20 sm:w-1/2 md:w-1/4 xl:w-1/6 mt-8 md:mt-0">
              <h5 className="text-3xl font-bold mb-6 dark:text-white">Help</h5>
              <ul className="list-none footer-links">
                <li className="mb-2">
                  <a
                    href="#"
            ...
            <div className="px-4 mt-4 sm:w-1/3 xl:w-1/6 sm:mx-auto xl:mt-0 xl:ml-auto">
              <h5 className="text-3xl font-bold mb-6 sm:text-center xl:text-left dark:text-white">
                Stay connected
              </h5>
          ...
          <div className="sm:flex sm:flex-wrap sm:-mx-4 mt-6 pt-6 sm:mt-12 sm:pt-12 border-t  dark:border-gray-700 ">
            <div className="sm:w-full px-20 md:w-1/6">
              <strong className="dark:text-white">FWR</strong>
            </div>
            <div className="px-20 sm:w-1/2 md:w-1/4 mt-4 md:mt-0">
            ...
            <div className="px-5 md:w-1/4 md:ml-auto mt-6 sm:mt-4 md:mt-0">
